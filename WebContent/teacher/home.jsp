...
<body>
		...
		<div class="container-fluid">
			<div class="navbar-header">
				<div class="navbar-brand">
					<small class="glyphicon glyphicon-fire"></small> 教练中心
				</div>
			</div>
			...
			<div class="panel-group" id="box">
					...
					<div class="panel-collapse collapse in" id="collapseA">
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><a href="teacher_edit?id=${existTeacher.id}" target="content">修改信息</a></li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="panel panel-success">
					...
					<div class="panel-collapse collapse in" id="collapseB">
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
								<li><a href="add.jsp" target="content">发布课程</a></li>
								<li><a href="course_findMyCourse" target="content">查看自己教授课程</a></li>
							</ul>
						</div>
					</div>
				</div>
	...
	<div style="float: left; width: 80%;" id=" main">
		...
		<iframe id="content" name="content" frameborder="0"
			...
			style="min-height: 650px; min-width: 100%"> </iframe>
	</div>
