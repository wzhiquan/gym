		...
		<div>
			<div class="input-group" style="width: 30%">
				<span class="input-group-addon">课名</span> <input type="text"
					name="name" class="form-control" placeholder="瑜伽"
					style="width: 100%" id="course_name">
			</div>
			<br>
			<div class="input-group" style="width: 30%">
				<span class="input-group-addon">地点</span> <input type="text"
					name="place" class="form-control" placeholder="911"
			...
			<br>
			<div class="input-group" style="width: 30%">
				<span class="input-group-addon">教练名</span> <input type="hidden"
					name="teacher.id" value = "${existTeacher.id}"  class="form-control" readonly="readonly"
					style="width: 100%">
					
					<input type="text" 
					 value = "${existTeacher.name}"  class="form-control" readonly="readonly"
					style="width: 100%">
			</div>
			<br>
