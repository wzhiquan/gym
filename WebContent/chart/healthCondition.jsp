...
<body>
<div id="div2" style="width:900px;height:400px;border:1px solid #dddddd;margin:10px auto;"></div>
        ...
        require(
            ...
            function (ec) {
             ...
             // 载入动画---------------------
                ...
                $.ajax({
                    url : "charts_qryHealthData?userid=${health.userid}",
                    dataType : "json",
                             ...
                             if(data!=null && data["series"].length>0){
                                 ...
                                 for(var i=0,len=data["series"].length;i<len;i++){
                                     seriesData.push({
                                      ...
                                      alert(legendData[i]+data["series"][i]);
                                 }
                             }
                              
                        option.title.text="健康状况报表";
